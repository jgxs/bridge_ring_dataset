...
smi = {}
with open("/home/chengyj/kinase_work/Bridged_ring/pkidb_rings/bridged.csv") as smi_file:
    for line in smi_file:
        smi[line.split()[0]] = line.split()[1]
with open("/home/chengyj/kinase_work/Bridged_ring/pkidb_rings/spiro.csv") as smi_file:
    for line in smi_file:
        smi[line.split()[0]] = line.split()[1]
...
for key in smi:
    ...
    if r.status_code == 200:
        ...
        with open("bridge_complex.csv","a") as output:
            output.write(f"{key:>15} {result}")